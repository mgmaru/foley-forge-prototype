...
- **注意**：Phase 2 の自動調整で「採用率」だけを上げにいくと、無難な音に収束して**探索＝AIの創造性が潰れる**。多様性は「守るべき目標」として明示的に残す。
...
| 手動→自動（2フェーズ） | まず手動チューニング。**手動が頭打ちになってから**自動化 |
...
| 自動調整は今要るか | 手動が頭打ちになる証拠が出るまで、Phase 2 は保留が筋では（`design-notes.md` 6/1 の Skill 判断と同じ理屈） |
